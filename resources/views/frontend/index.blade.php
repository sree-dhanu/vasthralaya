                            ...
                            <table class="table">
                                <tbody>
                                    ...
                                    @foreach($contents as $val)
                                        ...
                                        <td><img src="/productsimage/{{$val->pimage}}" alt="product_image" width="250px" height="250px"><br>
                                        <label for="pname"><b>Product Name:</b><br></label>{{$val->pname}}<br>
                                           <label for="descript"><b>Product Description:</b><br></label> {{$val->pdescription}}
                                        </td>
                                        @endforeach
                                    </tr>
